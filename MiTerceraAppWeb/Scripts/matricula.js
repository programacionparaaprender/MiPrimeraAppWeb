        ...
        $.get(url + '/Cursos?iidmatricula=' + IID, function(data){
            ...
            for(let dat of data){
                ...
                if(dat.bhabilitado == 1){
                    contenido += "<input class='checkbox' type='checkbox' id='"+dat.IIDCURSO+"' checked='true' />";
                } else {
                    contenido += "<input class='checkbox' type='checkbox' id='" + dat.IIDCURSO +"' />";
                }
                contenido += '</td>';
                contenido += '<td>';
                contenido += dat.NOMBRE;
                contenido += '</td>';
                contenido += '</tr>';
            }
            contenido += "</tbody>";
